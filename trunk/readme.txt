...
* Show <a href="https://gravatar.com/?">Gravatar</a> for Authors above their name and rankings / list table.
...
Useful for rankings and list of anything you desire but optimized for ranking athletes. For example: You can upload (or manually create) a list of NFL players then authors can sort those rankings in post or pages. You can create top 10 list, top 100 list, top 10 rankings etc for NFL, MLB, NBA and NHL players with ease! Fantasy Football websites will find this extremely useful when creating <a href="http://fantasyknuckleheads.com/fantasy-football-rankings/" title="fantasy football rankings">fantasy football rankings</a> for the draft and weekly matchups. 
...
5. You can rank and list anything you want! Great list creator.
